...
typealias MetalRadioResponseCallback = (videos: Array<Video>?, error: NSError?) -> Void

class MetalRadioClient {
    
    static let errorDomain = "MetalRadioClientErrorDomain"
    
    static let baseURLString = "http://134.213.62.164:8080"
    
    static let songsSearchPath = "/songs/search?"
    
    static let keyword = "metal"
